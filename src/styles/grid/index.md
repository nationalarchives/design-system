...
[TNA Frontend](../../get-started/tna-frontend/) comes with a responsive grid system based on the user’s [device size](../devices/#device-sizes).

{{ example({ title: "Grid example", group: "styles", item: "grid", example: "columns", html: true, nunjucks: false, size: "l" }) }}
...
{{ example({ title: "Columns example", group: "styles", item: "grid", example: "columns-no-width", html: true, nunjucks: false, size: "s" }) }}
...
{{ example({ title: "Responsive columns example", group: "styles", item: "grid", example: "responsive-columns", html: true, nunjucks: false, size: "l" }) }}
...
{{ example({ title: "Flexible columns example", group: "styles", item: "grid", example: "flexible-columns", html: true, nunjucks: false, size: "s" }) }}

## Changing alignment

### Horizontal alignment

{{ example({ title: "Horizontal alignment example", group: "styles", item: "grid", example: "container-alignment", html: true, nunjucks: false, size: "l" }) }}

### Vertical alignment

{{ example({ title: "Vertical alignment example", group: "styles", item: "grid", example: "column-alignment", html: true, nunjucks: false, size: "l" }) }}
...
{{ example({ title: "Nested containers example", group: "styles", item: "grid", example: "nested-containers", html: true, nunjucks: false, size: "l" }) }}
