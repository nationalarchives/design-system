...
{{ example({ title: "Table example", group: "styles", item: "tables", example: "plain-table", html: true, nunjucks: false, size: "l" }) }}
...
{{ example({ title: "Scrollable table example", group: "styles", item: "tables", example: "table-wrapper", html: true, nunjucks: false, size: "xxxl" }) }}
