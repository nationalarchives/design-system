...
{{ example({ title: "Button accented example", group: "components", item: "button", example: "accent", html: true, nunjucks: true, size: "xxxs" }, 4) }}

### Plain

Use plain buttons to provide the same size and spacing as other buttons but with a more subtle visual style.

{{ example({ title: "Button plain example", group: "components", item: "button", example: "plain", html: true, nunjucks: true, size: "xxxs" }, 4) }}

### Small

Smaller buttons can be used when space is limited, such as in admin interfaces.

{{ example({ title: "Button small example", group: "components", item: "button", example: "small", html: true, nunjucks: true, size: "xxxs" }, 4) }}
...
{{ example({ title: "Button icons example", group: "components", item: "button", example: "icon", html: true, nunjucks: true, size: "xxxs" }, 4) }}
...
{{ example({ title: "Button icon-only example", group: "components", item: "button", example: "icon-only", html: true, nunjucks: true, size: "xxxs" }, 5) }}
...
{{ example({ title: "Button SVG icon example", group: "components", item: "button", example: "icon-svg", html: true, nunjucks: true, size: "xxxs" }, 5) }}
...
{{ example({ title: "Button element example", group: "components", item: "button", example: "button-element", html: true, nunjucks: true, size: "xxxs" }) }}
