  ...
  .forEach((setCookiePreference) => {
    setCookiePreference.addEventListener("click", () => {
      ...
      if ($setCookiePreferenceParent.classList.contains("tna-button-group")) {
        ...
        // $setCookiePreferenceParent.setAttribute("tabindex", "0");
        // $setCookiePreferenceParent.addEventListener(
        //   "blur",
        //   () => {
        //     $setCookiePreferenceParent.removeAttribute("tabindex");
        //   },
        //   { once: true },
        // );
        // $setCookiePreferenceParent.focus();
      }
    });
  });
...
const resizeExampleIframes = () => {
  document
    .querySelectorAll(
      ".tna-ds-example__frame:not(.tna-ds-example__frame--fixed-height-on-load",
    )
    .forEach(($iframe) =>
...
window.addEventListener("resize", () =>
  document
    .querySelectorAll(".tna-ds-example__frame")
